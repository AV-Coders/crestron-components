...
public class SonyBdpSeriesOverCrestronIr : AVCoders.MediaPlayer.MediaPlayer
{
    ...
    public SonyBdpSeriesOverCrestronIr(string name, IROutputPort port) : base(name, CommunicationClient.None)
    {
        _port = port;
        _pulseTimeInMs = 100;
        port.LoadIRDriver($"{Directory.GetApplicationDirectory()}/sony_bdp_series.ir");
    }
